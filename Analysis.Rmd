...
d <- 
  ...
  theme(lot.background = element_rect(fill = "white", color = NA),
        legend.position = "none")
...
ggsave(file = "figures/Figure_S2.png", width = 5, height = 5, 
       dpi = 300, units = "in")
```
...
ggsave(file = "figures/Figure_S4.png", width = 6, height = 6, 
       dpi = 300, units = "in")
```
...
ggsave(file = "figures/Figure_S5.png", width =5, height = 5, 
       dpi = 300, units = "in")
```

## Figure S6

```{r FigS6, fig.height=6, fig.width=7.5}
# delta DOC ####################################################################
a <-
...
layoutGrid <- rbind(c(1,1,2,2,2,2),
                    c(1,1,3,3,3,3))
grob <- grid.arrange(a, b, c, layout_matrix = layoutGrid)
ggsave(grob, file = "figures/Figure_S6.png", 
       height = 6, width = 7.5, units = "in", dpi = 300)
```
